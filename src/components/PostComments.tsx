          ...
          {comments?.map(comment => {
            return (
              <div
                ...
                className="m-1 p-2 flex flex-col lg:w-5/6  min-w-fit justify-between w-full border border-gray-100 backdrop-blur-md rounded shadow-sm bg-white/50"
              >
                <div
                  className='flex flex-col justify-center  min-w-fit m-2 border border-gray-200 rounded'>
